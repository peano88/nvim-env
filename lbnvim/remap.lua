...
vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/.config/nvim/lua/lbompani/packer.lua<CR>");

vim.keymap.set("n", "<C-t>", "<C-v>")

vim.keymap.set("t", "<Esc>", [[ <C-\><C-n> ]])
vim.keymap.set("n", "<leader>o", vim.cmd.ClangdSwitchSourceHeader)

-- navigation between tabs 
--vim.keymap.set("n", "<A-j>", vim.cmd.tabnext)
--vim.keymap.set("n", "<A-k>", vim.cmd.tabprev)
